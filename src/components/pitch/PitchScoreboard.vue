...
const { table, rounds, currentScore, currentRound } = storeToRefs(usePitchStore());
    ...
    <div id="pitch-scoreboard" class="columns">
        ...
        <div id="pitch-scoreboard-round" class="column">
            <table id="pitch-scoreboard-round-table" class="table">
                <thead>
                    <tr>
                        <th>{{ t(textKeys.label_trump)}}</th>
                        <th>{{ t(textKeys.label_bid)}}</th>
                        <th>{{ t(textKeys.label_round)}}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <IconSuitOutline v-if="trumpSuit && trumpColor" :suit="trumpSuit" :color="trumpColor" />
                        </td>
                        <td>{{ bidText }}</td>
                        <td>{{ rounds.length }}</td>
                    </tr>
