import type { PitchOptions, PitchPlayErrorKey, PitchBidErrorKey } from "./types";
import type { ICardRank, ICardSuit, ICard, ICardFactory, IDeck, IDealer, ITable, IPlayer, IComparable } from "../card/interfaces"
import type { IntelligenceKey } from '../card/types'
...
interface IPitchTrick<
    ...
    getWinningPlay(trumpSuit: Suit): IPitchPlay<Rank,Suit,Card,Team,Bidr> | undefined,
}
...
interface IPitchCalculator<
    ...
    score(team: Team, 
        ...
        options: PitchOptions): IPitchScore<Rank,Suit,Card,Team,Bidr>,
    calculate(cards: Card[], trump: Suit): IPitchCalculation<Rank,Suit,Card>,
    calculateRound(round: IPitchRound<Rank,Suit,Card,Team,Bidr>, table: IPitchTable<Rank,Suit,Card,Team,Bidr>): IPitchRoundCalculation<Rank,Suit,Card,Team,Bidr> | undefined,
}
...
interface IPitchScoreboard<
    ...
    getScoresForRound(index: number): IPitchTeamScore<Rank,Suit,Card,Team,Bidr>[]
    getScoreForTeamAndRound(team: Team, index: number): IPitchScore<Rank,Suit,Card,Team,Bidr> | undefined,
    getScoreTotal(team: Team): number,
    getWinner(options?: PitchOptions): Team | undefined,
    pushScores(round: IPitchRoundCalculation<Rank,Suit,Card,Team,Bidr>, 
        options?: PitchOptions): void,
}
...
interface IPitchDealer<
    ...
    playPitch(state: IPitchState<Rank, Suit, Card, Team, Bidr>,
        callbackShowCards: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, bidder: Bidr) => Promise<boolean>, 
        callbackBid: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, bidder: Bidr, error?: PitchBidErrorKey) => Promise<IPitchBid<Rank, Suit, Card, Team, Bidr>>, 
        callbackSelectCard: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, bidder: Bidr, error?: PitchPlayErrorKey) => Promise<Card>, 
        callbackShowTrickResult: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, winner: IPitchPlay<Rank, Suit, Card, Team, Bidr>) => Promise<void>,
        callbackShowRoundResult: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, calculation: IPitchRoundCalculation<Rank, Suit, Card, Team, Bidr>) => Promise<void>,
        callbackShowPitchResult: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, team: Team) => Promise<void>,
        callbackRefresh: (state: IPitchState<Rank, Suit, Card, Team, Bidr>, message?: string) => Promise<void>)
        : Promise<IPitchState<Rank, Suit, Card, Team, Bidr>>,
    dealHands(state: IPitchState<Rank,Suit,Card,Team,Bidr>, 
        callbackRefresh: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, message?: string) => Promise<void>): Promise<IPitchState<Rank,Suit,Card,Team,Bidr>>,
    takeBids(state: IPitchState<Rank,Suit,Card,Team,Bidr>, 
        callbackShowCards: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, bidder: Bidr) => Promise<boolean>,
        callbackBid: (state:IPitchState<Rank,Suit,Card,Team,Bidr>,bidder:Bidr,error?: PitchBidErrorKey) => Promise<IPitchBid<Rank,Suit,Card,Team,Bidr>>,
        callbackRefresh: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, message?: string) => Promise<void>): Promise<IPitchState<Rank,Suit,Card,Team,Bidr>>,
    takePlays(state: IPitchState<Rank,Suit,Card,Team,Bidr>,
        callbackShowCards: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, bidder: Bidr) => Promise<boolean>,
        callbackSelectCard: (state:IPitchState<Rank,Suit,Card,Team,Bidr>,bidder:Bidr,error?: PitchPlayErrorKey) => Promise<Card>,
        callbackRefresh: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, message?: string) => Promise<void>): Promise<IPitchState<Rank,Suit,Card,Team,Bidr>>,
    pushScores(state: IPitchState<Rank,Suit,Card,Team,Bidr>,
        callbackShowRoundCalc: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, calculation: IPitchRoundCalculation<Rank,Suit,Card,Team,Bidr>) => Promise<void>,
        callbackRefresh: (state:IPitchState<Rank,Suit,Card,Team,Bidr>, message?: string) => Promise<void>): Promise<IPitchState<Rank,Suit,Card,Team,Bidr>>,
}
...
interface IPitchAI<
    ...
    Team extends IPitchTeam<Rank,Suit,Card,Team>,
    Bidr extends IPitchBidder<Rank,Suit,Card,Team,Bidr>> {
    decideBid(bidder: Bidr, state: IPitchState<Rank,Suit,Card,Team,Bidr>): IPitchBid<Rank,Suit,Card,Team,Bidr>,
    decidePlay(bidder: Bidr, state: IPitchState<Rank,Suit,Card,Team,Bidr>): Card
}
...
interface IPitchAIFactory<
    ...
    Team extends IPitchTeam<Rank,Suit,Card,Team>,
    Bidr extends IPitchBidder<Rank,Suit,Card,Team,Bidr>> {
    selectIntelligence(key: IntelligenceKey): IPitchAI<Rank,Suit,Card,Team,Bidr> | undefined
}
