...
import {
  DefineLocaleMessage, // eslint-disable-line @typescript-eslint/no-unused-vars
...
declare module "vue-i18n" {
  export interface DefineLocaleMessage {
    ...
    pitch: {
      ...
      title_invalid_bid_for: string;
      title_invalid_play_for: string;
